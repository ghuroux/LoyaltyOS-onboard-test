...
import { Star, DollarSign, Ticket, RefreshCw, Plus, Edit2, Trash2, ChevronDown, ChevronUp, QrCode, Smartphone, CreditCard, Phone, Bell, Store, Monitor, Users } from 'lucide-react';
