  ...
  },
  {
    ...
    signals: [
      ...
      },
      {
        ...
        name: 'Low Table Turnover Rate',
        description: 'Restaurant table turnover below efficiency threshold (industry-specific)',
        enabled: false,
        ...
        unit: 'absolute',
        priority: 'medium',
        actions: ['Alert restaurant manager', 'Review service timing', 'Analyze peak hours', 'Compare with high-performing locations'],
        cooldownHours: 48,
      },
    ],
  },
...
export const useOnboardingStore = create<OnboardingState>((set, get) => ({
  ...
  nextScreen: () => set((state) => ({
    currentScreen: Math.min(state.currentScreen + 1, 15),
  })),
